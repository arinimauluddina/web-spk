...
<?php  include '../config/koneksi.php'; //file database yang sudah di buat
...
?>
    ...
    <script src="js/jam.js">
            ...
            <div id="wrap">
                    ...
                    <!-- <button class="kr"><i class="fa fa-plus"></i>&nbsp;Tambah Kriteria</button> -->
            </div>
            <!-- Button Modal -->
<!-- <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal"> -->
     <a class="bie-slide2" style=" margin-left: 270px;" class="btn btn-danger" data-toggle="modal" data-target="#myModal" >
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Form Tambah Kriteria</h4>
      </div>
      <div class="modal-body">
        <form action="" method="POST" role="form">
         ...
         <div class="form-group">
          ...
          <input type="text" name="kriteria" class="form-control" id="" autocomplete="off">
         </div>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="tambah" class="btn btn-success btn-md">Tambah</button>
       </form>
      </div>
    </div>
  </div>
            ...
            <div class ="row" style="margin-left:250px;width:50%;margin-top:0px;">
                <div class="col-lg-12">
            ...
            while($d = mysqli_fetch_array($data)){
                ...
                <tr>
                    ...
                    <td style="text-align:center">
                     <a href="hapus_kriteria.php ?kriteria=<?php echo $d['id_kriteria'];?>">
                    <button class="bdelete" onclick="return confirm ('Apakah Yakin dihapus');"><i class="fa fa-trash-o"></i>&nbsp; Hapus</button></a> 
                    <a href="kriteria_atribut.php?kriteria=<?php echo $d['id_kriteria'];?>">
                    <button class="bsee" ><i class="fa fa-envelope-o"></i>&nbsp; Detail</button></a> 
                     </td>
   ...
   <div id="modal-konfirmasi" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <div class="modal-footer">
                    <a href="hapus_kriteria.php" class="btn btn-danger" id="hapus-true-data">Hapus</a>
...
// Mengisi atribut href pada tombol ya yang kita berikan id hapus-true pada modal .
    // modal.find('#hapus-true-data').attr("href","hapus_kriteria.php?id="+id);
    })
